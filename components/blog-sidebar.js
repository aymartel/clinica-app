...
import imageINMGRATIONEXAM from "@/images/blog/imageINMGRATIONEXAM.webp";
          ...
          <ul>
          {
                ...
                <li>
                  <a href={t('Blog_INMGRATIONEXAM_URL')}>
                    <div className="img-block">
                      <Img src={imageINMGRATIONEXAM} alt="image INMGRATIONEXAM" layout="responsive" />
                    </div>
                    {t('Blog_INMGRATIONEXAM_Title')}
                  </a>
                </li>
                : null
            }
            ...
            }
            {
              (router.asPath != t('Blog_BloodHighPresure_URL')) ?
                <li>
                  <a href={t('Blog_BloodHighPresure_URL')}>
                    <div className="img-block">
                      <Img src={imageBloodHighPresure} alt="image BloodHighPresure" layout="responsive" />
                    </div>
                    {t('Blog_BloodHighPresure_Title')}
                  </a>
                </li>
                : null
            }
