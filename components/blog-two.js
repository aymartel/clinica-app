  ...
  return (
    <section className="blog_share_area section_padding blog-page">
      <Container>
        <Row>
          <Col lg={4} md={6} sm={12} >
            <BlogCard image={imageCheckUps} date={t('Blog_CheckUps_Date')} title={t('Blog_CheckUps_Title')} url={t('Blog_CheckUps_URL')} text={t('Blog_CheckUps_Text')} />
          </Col>
          <Col lg={4} md={6} sm={12} >
          ...
          <Col lg={4} md={6} sm={12} >
            <BlogCard image={imageVaginosis} date={t('Blog_Vaginosis_Date')} title={t('Blog_Vaginosis_Title')} url={t('Blog_Vaginosis_URL')} text={t('Blog_Vaginosis_Text')} />
          </Col>
          <Col lg={4} md={6} sm={12} >
          ...
          <Col lg={4} md={6} sm={12} >
            <BlogCard image={imageObesity} date={t('Blog_Obesity_Date')} title={t('Blog_Obesity_Title')} url={t('Blog_Obesity_URL')} text={t('Blog_Obesity_Text')} />
          </Col>
          <Col lg={4} md={6} sm={12} >
            <BlogCard image={imageBloodTest} date={t('Blog_BloodTest_Date')} title={t('Blog_BloodTest_Title')} url={t('Blog_BloodTest_URL')} text={t('Blog_BloodTest_Text')} />
          </Col>
          <Col lg={4} md={6} sm={12} >
            <BlogCard image={imageMammogram} date={t('Blog_Mammogram_Date')} title={t('Blog_Mammogram_Title')} url={t('Blog_Mammogram_URL')} text={t('Blog_Mammogram_Text')} />
          </Col>
          <Col lg={4} md={6} sm={12} >
            <BlogCard image={imageDiabetes} date={t('Blog_Diabetes_Date')} title={t('Blog_Diabetes_Title')} url={t('Blog_Diabetes_URL')} text={t('Blog_Diabetes_Text')} />
          </Col>
          <Col lg={4} md={6} sm={12} >
            <BlogCard image={imageProstateExamination} date={t('Blog_ProstateExamination_Date')} title={t('Blog_ProstateExamination_Title')} url={t('Blog_ProstateExamination_URL')} text={t('Blog_ProstateExamination_Text')} />
          </Col>
        </Row>
      </Container>
    </section>
